...
async function handleRequest(request) {
  ...
  if(!path){
    ...
    const html= await fetch("https://qianzhiweisppc.github.io/shorturls/"+config.theme+"/index.html")
  ...
  if (location) {
    if (config.no_ref=="on"){
      let no_ref= await fetch("https://qianzhiweisppc.github.io/shorturls/no-ref.html")
